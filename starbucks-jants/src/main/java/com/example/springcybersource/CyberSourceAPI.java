...
public class CyberSourceAPI {
    ...
    */
    ...
    // used to get appropraite card type
    ...
    public static String getCardType(String cardNumnber) {
        String first_digit = cardNumnber.substring(0, 1);
        String result = "ERROR";
        // american express
        if(first_digit.equals("3")){
            result = "003";
        }
        // visa
        if(first_digit.equals("4")){
            result = "001";
        }
        // mastercard
        if(first_digit.equals("5")){
            result = "002";
        }
        // discover
        if(first_digit.equals("6")){
            result = "004";
        }
